...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        if(cursor!=null && cursor.getCount() > 0){
            ...
            long createdTime = cursor.getLong(cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_CREATION_TIME));
            int plantType = cursor.getInt(cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_PLANT_TYPE));
            cursor.close();
            imgRes = PlantUtils.getPlantImageRes(this, timeNow - createdTime, timeNow - lastWatered, plantType);
        }
