...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        //  (3): Set the click handler to open the DetailActivity for plant ID,
        ...
        views.setTextViewText(R.id.plant_widget_id, String.valueOf(plantId));
        // Update image
    ...
    //  (2): Modify updatePlantWidgets and updateAppWidget to pass the plant ID as well as a boolean
